            ...
            <div className="header-right">
              {
                !token ? <>
                  ...
                  <Link href={`http://feriwalacourier.com/home/?token=${getCookie('token')}`} passHref>
                  ...
                  <Link href="/">
                    <div className="btn-wrap show-code-action">
                      <a href="#" className="btn btn-secondary btn-outline btn-ellipse" style={{ fontSize: 12 }} onClick={(e) => { removeCookies("token") }} >Sign Out</a>
                    </div>
                  </Link>
